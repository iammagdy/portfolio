...
export const PROJECTS: Project[] = [
  {
    title: 'megZone',
    date: '2024-2025',
    subtext: 'A centralized AI workspace that lets you launch and manage multiple AI apps from one streamlined interface.',
    urls: [{ text: 'VIEW', disabled: true }],
  },
  {
    title: 'Wise Prompt',
    date: '2025',
    subtext: 'An "All-in-One" AI workspace combining advanced prompt engineering, web scraping, and computer vision into a single interface.',
    urls: [{ text: 'CODE', url: 'https://github.com/iammagdy/Wise-Prompt' }],
  },
  {
    title: 'Wise Quran',
    date: '2025-2026',
    subtext: 'A modern, offline-first Quran Progressive Web App for reading, listening, and daily worship tracking.',
    urls: [
  ...
  },
  {
    title: 'Wise Resume',
    date: '2025-2026',
    subtext: 'AI career platform combining a resume builder (30+ templates, ATS scoring) with interview coaching, AI career tools, and an application tracker.',
    urls: [
  ...
  },
  {
    title: 'Portfolio',
    date: '2026',
    subtext: 'This very portfolio — a 3D immersive experience built with React Three Fiber, GSAP, and spatial scroll-driven animations.',
    urls: [{ text: 'CODE', url: 'https://github.com/iammagdy/MagdySaber_Portfolio' }],
  },
  {
    title: 'Wise Hire',
    date: '2026',
    subtext: 'An invite-only AI HR SaaS offering AI-written job descriptions, bulk CV screening, Kanban hiring pipeline, and enterprise SSO.',
    urls: [
  ...
  },
  {
    ...
    date: '2026',
    subtext: 'A dual-product AI platform serving both job seekers and HR teams from one connected ecosystem.',
    urls: [
  ...
  },
  {
    ...
    date: '2026',
    subtext: 'A Chrome extension automating LinkedIn candidate sourcing using Gemini AI — with profile scoring, skill-gap analysis, and outreach generation.',
    urls: [{ text: 'VIEW', disabled: true }],
  },
];
